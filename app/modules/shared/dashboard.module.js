System.register(['./section/section.component', './dashboard/dashboard.component', '@angular/core', './routing.module', '@angular/common'], function(exports_1, context_1) {
    "use strict";
    ...
    var section_component_1, dashboard_component_1, core_1, routing_module_1, common_1;
    var DashboardModule;
    return {
        setters:[
        ...
        execute: function() {
            DashboardModule = (function () {
                ...
                DashboardModule = __decorate([
                    core_1.NgModule({
                        imports: [common_1.CommonModule, routing_module_1.RoutesModule],
                        declarations: [
